...
export default function Player({ id }) {
  ...
  return <div className='dark-screen'><Img src={item.image} label='' className='bgimg' /><div className='veil' /><div className='inner'>
    <div className='player-top'><button className='iconbtn' onClick={back} aria-label={copy.close}><Icon name='down' /></button><span className='grow' /><button className='iconbtn' onClick={() => audio.toggleFavorite(item.id)} aria-label={marked ? copy.unsave : copy.save} aria-pressed={marked}><Icon name='heart' fill={marked} /></button><button className='iconbtn' onClick={() => go('audio', item.slug)} aria-label={copy.details}><Icon name='more' /></button></div>
