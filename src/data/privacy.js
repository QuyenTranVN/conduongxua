export const PRIVACY_TRANSLATIONS = {
  vi: {
    ...
    cards: {
      ...
      local: { icon: 'gear', title: 'Không cần tài khoản', body: 'Bạn có thể sử dụng ứng dụng mà không cần tạo tài khoản. Hiện tại, dữ liệu sử dụng được lưu trực tiếp trong trình duyệt hoặc trên thiết bị và không được đồng bộ với tài khoản đám mây.' },
    ...
    choices: { title: 'Dữ liệu của bạn', body: 'Bạn có thể:', items: ['bỏ nội dung yêu thích trong ứng dụng', 'thay đổi tùy chọn của mình', 'xóa dữ liệu cục bộ trong phần Cài đặt của ứng dụng', 'liên hệ với chúng tôi về quyền riêng tư'], action: 'Liên hệ về quyền riêng tư' },
  ...
  en: {
    ...
    cards: {
      ...
      local: { icon: 'gear', title: 'No account required', body: 'You can use the app without creating an account. Usage data is currently stored directly in your browser or on your device and is not synced to a cloud account.' },
    ...
    choices: { title: 'Your data', body: 'You can:', items: ['remove favourite content in the app', 'change your preferences', 'clear local data from the app’s Settings drawer', 'contact us about privacy'], action: 'Contact us about privacy' },
