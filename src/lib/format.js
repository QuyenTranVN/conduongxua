...
export const UI_TEXT = {
  vi: {
    ...
    audioBrowse: {
      ...
      pause: 'Tạm dừng', play: 'Phát', details: 'Chi tiết', unknownTeacher: 'Chưa cập nhật', durationPending: 'Thời lượng đang cập nhật', empty: 'Chưa có nội dung phù hợp.', items: 'bài', playlist: 'Kinh tụng theo ngày', playlistDescription: 'Bảy thời kinh tụng được sắp xếp theo ngày để bạn dễ chọn và nghe liên tục.', tracks: 'bài tụng', suttaPlaylist: 'Kinh giảng — Ashin Sarana', suttaPlaylistDescription: 'Hai bài giảng kinh được sắp xếp thành danh sách phát liên tục.',
    },
    player: {
  ...
  en: {
    ...
    audioBrowse: {
      ...
      pause: 'Pause', play: 'Play', details: 'Details', unknownTeacher: 'Not yet available', durationPending: 'Duration not yet available', empty: 'No matching content is available.', items: 'items', playlist: 'Daily chanting', playlistDescription: 'Seven chanting services arranged by day for easy selection and continuous listening.', tracks: 'chants', suttaPlaylist: 'Sutta teachings — Ashin Sarana', suttaPlaylistDescription: 'Two sutta teachings arranged for continuous listening.',
    },
    player: {
