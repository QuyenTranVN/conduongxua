...
export const MEDITATION_SESSIONS = [
  ...
  { id: 'ms4', titleVi: 'Tâm từ cho người mới', methodId: 'metta', teacherId: 'brahm', durationSeconds: 600, guidanceType: 'guided', language: 'vi', level: 'beginner', audioUrl: '/audio/metta-10.mp3' },
  ...
  { id: 'ms6', titleVi: 'Nhận biết toàn thân', methodId: 'body', teacherId: 'sumedho', durationSeconds: 1200, guidanceType: 'guided', language: 'vi', level: 'beginner', audioUrl: '/audio/body-20.mp3' },
  { id: 'ms7', titleVi: 'Quán sát cảm giác', methodId: 'body', durationSeconds: 1800, guidanceType: 'silent', language: 'vi', level: 'regular' },
  { id: 'ms8', titleVi: 'Tỉnh thức trong từng bước', methodId: 'walking', teacherId: 'pasanno', durationSeconds: 600, guidanceType: 'guided', language: 'vi', level: 'beginner', audioUrl: '/audio/walking-10.mp3' },
