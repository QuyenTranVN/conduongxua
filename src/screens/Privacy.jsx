...
export default function Privacy() {
  ...
  return <><AppBar title={copy.pageTitle} /><div className='scroll has-mini privacy-page buddhist-page-background'><main className='privacy-inner'>
    ...
    {isSafeWebUrl(PRIVACY_CONFIG.policyUrl) && <a className='privacy-policy-link' href={PRIVACY_CONFIG.policyUrl} target='_blank' rel='noopener noreferrer'>{copy.fullPolicy} →</a>}
