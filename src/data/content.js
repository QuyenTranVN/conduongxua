...
export const TEACHERS = [
  { id:'jayasaro', name:'Ajahn Jayasaro', lineage:'chah', years:'1958–',
    img:'/images/teachers/jayasaro.jpg', talks:62, meditations:12,
  ...
  { id:'brahm', name:'Ajahn Brahm', lineage:'chah', years:'1951–',
    img:'/images/teachers/brahm.jpg', talks:58, meditations:8,
  ...
  { id:'sumedho', name:'Ajahn Sumedho', lineage:'chah', years:'1934–',
    img:'/images/teachers/sumedho.jpg', talks:74, meditations:10,
  ...
  { id:'chah', name:'Ajahn Chah', lineage:'chah', years:'1918–1992',
    img:'/images/teachers/chah.jpg', talks:95, meditations:6,
  ...
  { id:'pasanno', name:'Ajahn Pasanno', lineage:'chah', years:'1949–',
    img:'/images/teachers/pasanno.jpg', talks:41, meditations:7,
  ...
  { id:'mun', name:'Ajahn Mun Bhūridatta', lineage:'forest', years:'1870–1949',
    img:'/images/teachers/mun.jpg', talks:12, meditations:0,
  ...
  { id:'thanissaro', name:'Ṭhānissaro Bhikkhu', lineage:'forest', years:'1949–',
    img:'/images/teachers/thanissaro.jpg', talks:88, meditations:14,
...
export const USER = { name:'Ananda', rank:'Saddhā', streakDays:15 }
